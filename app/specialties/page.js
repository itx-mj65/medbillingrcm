...
const SPECIALTIES = [
  ...
  { slug:"neurosurgery-billing-service",        label:"Neurosurgery",      icon:"🧪", badge:"Complex Coding",   desc:"Neurosurgical CPT coding, spinal procedures, add-on codes, and intraoperative monitoring billing.",                  status:"live",  featured:false },
  ...
  { slug:"pathology-billing-services",          label:"Pathology",         icon:"🔭", badge:"Lab & Tissue",     desc:"Technical and professional pathology billing, tissue examination codes, and molecular lab claims.",                  status:"live",  featured:false },
  { slug:"clinical-lab-billing-service",        label:"Clinical Lab",      icon:"🧫", badge:"PAMA Compliant",   desc:"PAMA-compliant lab billing, ABN management, NCCI edits, and molecular diagnostics coding.",                          status:"live",  featured:false },
  { slug:"wound-care-billing-services",         label:"Wound Care",        icon:"🩹", badge:"Debridement",      desc:"Wound debridement coding, skin substitute claims, NPWT billing, and LCD compliance.",                              status:"live",  featured:false },
  { slug:"nursing-home-billing-services",       label:"Nursing Home",      icon:"🏠", badge:"SNF & PDPM",       desc:"SNF PDPM billing, Medicare Part A and B, MDS accuracy, consolidated billing, and Medicaid.",                        status:"live",  featured:false },
  { slug:"infectious-disease-billing-service",  label:"Infectious Disease",icon:"🦠", badge:"HIV & Infusion",    desc:"HIV/AIDS billing, antibiotic infusion coding, hospital consult E/M, and ICD-10 specificity.",                       status:"live",  featured:false },
  { slug:"immunology-billing-services",         label:"Immunology",        icon:"🛡️", badge:"Allergy & Biologic","desc":"Allergy testing and immunotherapy billing, biologic J-code infusion coding, and prior authorization.",              status:"live",  featured:false },
  ...
  { slug:"rehab-billing-service",               label:"Rehab",             icon:"🏃", badge:"PT/OT/ST",         desc:"Inpatient and outpatient rehab billing, PPS payment, functional outcome reporting, and Medicare compliance.",        status:"live",  featured:false },
  ...
  { slug:"hipaa-compliant-oncology-billing-service",label:"Oncology (HIPAA)",icon:"🎗️",badge:"HIPAA Certified","desc":"HIPAA-certified oncology billing with complete audit trail, drug administration coding, and appeals support.",    status:"live",  featured:false },
