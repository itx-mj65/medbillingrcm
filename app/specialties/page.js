...
const SPECIALTIES = [
  ...
  { slug:"cardiology-billing-service",          label:"Cardiology",        icon:"❤️", badge:"Interventional",   desc:"Complex interventional and diagnostic billing, device coding, and cardiac catheterization claims.",                  status:"planned" },
  { slug:"gastroenterology-billing-service",    label:"Gastroenterology",  icon:"🔭", badge:"Procedural",       desc:"Endoscopy and colonoscopy billing, polyp coding, anesthesia coordination, and payer compliance.",                   status:"planned" },
  ...
  { slug:"ophthalmology-billing-service",       label:"Ophthalmology",     icon:"👁️", badge:"Vision & Surgery", desc:"Ophthalmic surgical and diagnostic coding, cataract billing, vision therapy, and E/M integration.",                 status:"planned" },
  ...
  { slug:"psychiatric-billing-service",         label:"Psychiatry",        icon:"🧘", badge:"Behavioral Health", desc:"Psychiatric E/M coding, therapy add-ons, MHPAEA compliance, and collaborative care billing.",                      status:"planned" },
  ...
  { slug:"dme-billing-services",                label:"DME",               icon:"♿", badge:"DMEPOS",           desc:"DMEPOS billing, CMN documentation, Medicare Local Coverage Determination, and competitive bidding.",                 status:"planned" },
  ...
  { slug:"dental-billing-service",              label:"Dental",            icon:"🦷", badge:"CDT & Medical",    desc:"CDT coding, cross-coding for medical dental procedures, implant billing, and benefit coordination.",                 status:"planned" },
  ...
  { slug:"ambulatory-surgery-billing-service",  label:"Ambulatory Surgery",icon:"🏥", badge:"APC & ASC",        desc:"APC and ASC billing, facility fee optimization, modifier compliance, and same-day surgery coding.",                  status:"planned" },
