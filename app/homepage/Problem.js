export default function Problem() {
  return (
    <section className="reveal section problem" id="problem">
      <div className="shell">
        <div className="section-head reveal">
          <p className="reveal eyebrow">The revenue gap</p>
          <h2 className="reveal">Most Practices Are Losing Revenue They Have Already Earned</h2>
        ...
        <div className="problem-grid">
          <article className="issue reveal">
            ...
            <h3 className="reveal">Denial rates keep climbing</h3>
          ...
          <article className="issue reveal">
            ...
            <h3 className="reveal">Aging AR that nobody works</h3>
          ...
          <article className="issue reveal">
            ...
            <h3 className="reveal">No revenue visibility for leadership</h3>
          ...
          <article className="issue reveal">
            ...
            <h3 className="reveal">Compliance risk at every touchpoint</h3>
