        ...
        <div className="fit-grid">
          <article className="fit-card good reveal">
            ...
            <ul>
              ...
              <li>You have seen denial rates rise or AR aging degrade</li>
              <li>You want full revenue cycle visibility, not just billing execution</li>
              <li>You are expanding, acquiring, or restructuring operations</li>
              <li>You are preparing for a sale, merger, or ownership transition</li>
            </ul>
          </article>
          <article className="fit-card less reveal">
            ...
            <ul>
              ...
              <li>You want to keep an in-house billing department</li>
              <li>You prefer monthly reporting over live dashboards</li>
            </ul>
          </article>
        </div>
      </div>
