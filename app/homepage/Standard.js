    ...
    <section className="reveal section standard" id="standard">
      <div className="shell standard-grid">
        ...
        <div className="standard-copy reveal">
          ...
          <p>Our processes were built around the payer environment that exists now: automated denial engines, prior authorization lists that expand mid-year, the 288 new CPT codes that landed this year. We also work with a focused number of practices rather than a large book of accounts, so your payer mix and denial patterns are things our team knows rather than things we look up.</p>
          <p>HIPAA-compliant infrastructure and executed Business Associate Agreements were in place before our first engagement. Medbilling RCM does not require long-term contracts.</p>
        </div>
      </div>
    </section>
  );
