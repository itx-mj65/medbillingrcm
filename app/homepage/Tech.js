    ...
    <section className="reveal tech">
      <div className="tech-grid">
        ...
        <div className="tech-copy">
          <p className="reveal eyebrow">Human judgment, operational scale</p>
          <h2 className="reveal">Technology Runs the Volume. Specialists Make the Calls.</h2>
