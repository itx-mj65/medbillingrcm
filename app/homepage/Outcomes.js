export default function Outcomes() {
  return (
    <section className="reveal section outcomes" id="outcomes">
      <div className="shell">
        <div className="section-head reveal">
          <p className="reveal eyebrow">Published engagements</p>
          <h2 className="reveal">Client Outcomes</h2>
        ...
        <div className="outcome-summary reveal">
          <div>
            <h3 className="reveal">Results across published engagements</h3>
        ...
        <div className="case-grid">
          <article className="case reveal">
            ...
            <h3 className="reveal">Fee-for-service and capitation, running in one workflow</h3>
          ...
          <article className="case reveal">
            ...
            <h3 className="reveal">From zero collections to $43,678 a month</h3>
          ...
          <article className="case reveal">
            ...
            <h3 className="reveal">$60,000 retained through a records true-up audit</h3>
          ...
          <article className="case reveal">
            ...
            <h3 className="reveal">Collections up 340% on 40% more claims</h3>
